...
import FormNewLedger from './components/FormNewLedger';
...
const Transactions: React.FC = () => {
  ...
  const [currentLedger, setCurrentLedger] = useState<string | null>(null)
  const [ledgerName, setLedgerName] = useState<string>('')

  const { user, accounts, transactions, addTransaction, deleteTransaction, addAccount, loading, transactionsLoading, accountsLoading, ledgerLoading } = useAuth();
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        />
          ...
          <FormNewLedger loading={ledgerLoading} ledgerName={ledgerName} setLedgerName={setLedgerName} />
        )}
      </main>
    </div>
  );
